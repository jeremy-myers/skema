...
class GaussRBFNew : public KernelNew<MatrixType> {
 ...
 protected:
  ...
  // REMINDER! Interface using offsets is different than previous verison...
  // inline MatrixType& compute(const MatrixType& X,
  //                     const size_type mx,
  //                     const size_type nx,
  //                     const MatrixType& Y,
  //                     const size_type my,
  ...
  //                     const range_type offsets) override {
  //   Kokkos::Timer timer;
  ...
  //   using kernel = KernelNew<MatrixType>;
  ...
  //                       kij));
  //               data(ii, jj) = std::exp(-1.0 * kernel::gamma * kij);
  //             });
  //       });
  //   Kokkos::fence();
  ...
  // inline MatrixType& _compute(const matrix_type& X,
  //                      const matrix_type& Y,
...
//     _ncol = ncol;
//     _matrix =
//     matrix_type(Kokkos::ViewAllocateWithoutInitializing("_kmatrix"),
//                           nrow, ncol);
//     _gamma = gamma;
...
//   Kokkos::LayoutLeft>; using range_type = typename std::pair<size_type,
//   size_type>;
//  private:
